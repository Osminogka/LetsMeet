...
namespace LetsMeet.Pages
{
    public class AddFriendModel : UserPageModel
    {
        ...
        private async Task<int> GetTotalUsers()
        {
            ...
            List<string> TempFriendList = Context.userFriendLists.Where(obj => obj.MainUserName == UserName || obj.FriendUserName == UserName).Select(obj => obj.MainUserName == UserName ? obj.FriendUserName : obj.MainUserName).ToList();
